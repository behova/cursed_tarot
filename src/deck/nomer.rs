...
//utilities for interfacing and formating bbcode data

//transfers ownership of &str to caller
...
pub fn convert_to_vectors(path: std::ffi::OsString) -> (String, Vec<Vec<(String, String)>>) {
